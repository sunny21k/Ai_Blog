    ...
    <div className='relative'>
      ...
      <div className='max-w-3xl mx-auto'>
          ...
          <form onSubmit={addComment} className='flex flex-col items-start gap-4 max-w-lg'>
            ...
            <textarea onChange={(e) => setContent(e.target.value)} value={content} placeholder="Comment" className='w-full p-2 border border-gray-300 rounded outline-none h-48' required name="" id=""></textarea>
