  ...
  return (
    <div className='mx-8 sm:mx-16 xl:mx-24 relative'>
        <div className='text-center mt-20 mb-8'>
            ...
            <p className='my-6 sm:my-8 max-w-2xl m-auto max-sm:text-xs'>Welcome to QuickBlog — a 
                modern blogging platform where you can share your thoughts, 
                ideas, and stories with the world. Whether you're writing to express yourself or 
                inspire others, QuickBlog makes it easy to publish and connect.</p>
            <form onSubmit={onSubmitHandler} className='flex justify-between max-w-lg max-sm:scale-75 mx-auto border border-gray-300
             bg-white rounded overflow-hidden'>
                ...
                <button className='bg-primary text-white px-8 py-2 m-1.5 rounded hover:scale-105 
